...
- `PUT /api/verses/{book_id}/{chapter}/{verse}` - Save/update verse
- `DELETE /api/verses/{book_id}/{chapter}/{verse}` - Delete verse
- `POST /api/verses/chapters` - Save all verses in a chapter
- `DELETE /api/verses/chapters/{book_id}/{chapter}` - Clear chapter
- `POST /api/verses/books` - Save all verses in a book
