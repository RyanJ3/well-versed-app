...
def get_user_verses(
    ...
    return verse_service.get_user_verses(user_id, include_apocrypha)
...
def save_verse(
    ...
    return verse_service.save_or_update_verse(
...
def delete_verse(
    ...
    return verse_service.delete_verse(user_id, book_id, chapter_num, verse_num)
...
def save_chapter(
    ...
    return verse_service.save_chapter(user_id, book_id, chapter_num)
...
def clear_chapter(
    ...
    return verse_service.clear_chapter(user_id, book_id, chapter_num)
...
def save_book(
    ...
    return verse_service.save_book(user_id, book_id)
...
def clear_book(
    ...
    return verse_service.clear_book(user_id, book_id)


@router.delete("/{user_id}")
def clear_user_memorization(
    user_id: int,
    verse_service: VerseService = Depends(get_verse_service),
):
    return verse_service.clear_all_memorization(user_id)
