...
import { SetupStageComponent } from './stages/setup-stage/setup-stage.component';
...
import { PracticeStageComponent, PracticeSettings } from './stages/practice-stage/practice-stage.component';
import { CompletionStageComponent } from './stages/completion-stage/completion-stage.component';
...
buildAllStages() {
  ...
  goToFlow() {
    ...
    this.router.navigate(['/verse-workspace'], { queryParams });
  }
