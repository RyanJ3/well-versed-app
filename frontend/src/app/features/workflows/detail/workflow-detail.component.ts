...
import { WorkflowDetailResponse, WorkflowService } from '../../../core/services/workflow.service';
...
@Component({
  ...
  template: `
    <div class="workflow-detail" *ngIf="workflow">
      ...
      <div class="workflow-header">
        ...
        <div class="header-content">
          ...
          <div class="workflow-tags">
            <span class="tag" *ngFor="let tag of workflow.tags">{{ formatTag(tag) }}</span>
          </div>
        </div>
      ...
      <div class="progress-section" *ngIf="workflow.is_enrolled && workflow.user_progress">
        <div class="progress-info">
          <span class="progress-label">Your Progress</span>
          <span class="progress-text">
            {{ workflow.user_progress.lessons_completed }} / {{ workflow.lesson_count }} lessons completed
          </span>
        </div>
        ...
        <div class="lessons-list">
          ...
          >
            ...
            <div class="lesson-content">
              ...
              <div class="lesson-meta">
                <span class="lesson-type">
                  <svg *ngIf="lesson.content_type === 'video'" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                  <svg *ngIf="lesson.content_type === 'article'" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                  <svg *ngIf="lesson.content_type === 'external_link'" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                ...
                <span class="lesson-duration" *ngIf="lesson.content_data.video_duration">
            ...
            <div class="lesson-status">
              <svg *ngIf="isLessonCompleted(lesson)" class="status-icon completed" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
              <svg *ngIf="!isLessonUnlocked(lesson, i)" class="status-icon locked" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              ...
              <svg *ngIf="isCurrentLesson(lesson)" class="status-icon current" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
...
export class WorkflowDetailComponent implements OnInit {
  ...
  unenrollFromWorkflow() {
    this.modalService.confirm({
      title: 'Unenroll from Workflow',
      message: 'Are you sure you want to unenroll? Your progress will be saved.',
      type: 'warning',
      ...
      if (result.confirmed && this.currentUser && this.workflow) {
        ...
        this.workflowService.unenrollFromWorkflow(this.workflowId, userId).subscribe({
          next: () => {
            this.loadWorkflow();
          },
          error: (error) => {
  ...
  selectLesson(lesson: Lesson, index: number) {
    ...
    this.router.navigate(['/workflows', this.workflowId, 'lessons', lesson.id]);
  }
  ...
  isLessonCompleted(lesson: Lesson): boolean {
    ...
    const progress = this.workflow.user_progress;
    const lessonIndex = this.workflow.lessons.findIndex((l:any) => l.id === lesson.id);
