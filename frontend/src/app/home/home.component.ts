    ...
    <div class="home-container">
      <section class="hero-section">
        <div class="hero-content">
          <h1 class="hero-title">
            Welcome to <span class="app-name">Well Versed</span>
          </h1>
        ...
        <div class="features-grid">
          <div class="feature-card">
            ...
            <p class="feature-description">
              Track your progress through every book of the Bible with our
              visualization tools.
            </p>
          </div>
          ...
          <div class="feature-card">
            ...
            <p class="feature-description">
              First Letter Of Word technique helps you memorize scripture
          ...
          <div class="feature-card">
            ...
            <p class="feature-description">
              Spaced repetition flashcards help reinforce scripture memory for
              long-term retention.
            </p>
          </div>
        </div>
      ...
      <section class="stats-section">
        ...
        <p class="stats-caption">
          Track your progress through the entire Bible with our tools
        </p>
      </section>
      ...
      <section class="testimonials-section">
        ...
        <div class="testimonial-card">
          <div class="testimonial-text">
            "Well Versed has completely transformed my approach to memorizing
            scripture. The FLOW method made it possible for me to memorize
            entire chapters!"
          </div>
